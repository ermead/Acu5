...
class ScrollAndZoomViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let bodyImage = UIImage(named: "body_back")
        let herbs1Image = UIImage(named: "Herbs1")
        let herbs2image = UIImage(named: "Herbs2")
        
        
        
        arrayOfImages = [bodyImage!, herbs1Image!, herbs2image!]
        
        
        imageView = UIImageView(image: UIImage(named: "body_back"))
